...
public class StarredEventsFragment extends Fragment {
    ...
    ArrayList starredEvents = new ArrayList();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.starred_events_list_fragment, container, false);
        ...
        Log.i("HEX", hexStr);
        DatabaseReference usersRef = database.getReference("users").child(hexStr).child("starred_events");
    ...
    private class GetEvents extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... args) {
            ...
            for (int i = 0; i < starredEvents.size(); i++) {
                ...
                String id = starredEvents.get(i).toString();
                Log.i("ID", id);
                try {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ...
                    R.layout.starred_event_list_item, new String[]{"name", "date", "time", "eventlocation"}, new int[]{R.id.event_name, R.id.date, R.id.time, R.id.location});
